...
use gpui::{
    Anchor, App, AppContext, Context, Entity, InteractiveElement, IntoElement, KeyBinding, ParentElement as _, Render,
                    ...
                    .child(
                        Button::new("popup-menu-1")
                            ...
                            .dropdown_menu(move |this, window, cx| {
                                this.link(t!("menu.link.about").to_string(), "https://github.com/sxhxliang")
                                    .separator()
                                    .item(PopupMenuItem::new(t!("menu.item.handle_click").to_string()).on_click(
                                        window.listener_for(&view, |this, _, _, cx| {
                                            this.message = t!("menu.message.handle_click").to_string();
                                            cx.notify();
                                        }),
                                    ))
                                    .separator()
                                    ...
                                    .item(
                                        PopupMenuItem::element(|_, cx| {
                                            v_flex().child(t!("menu.item.custom_element").to_string()).child(
                                                div()
                                                    .text_xs()
                                        ...
                                        .on_click(window.listener_for(
                                            &view,
                                            |this, _, _, cx| {
                                                this.message = t!("menu.message.custom_element").to_string();
                                                cx.notify();
                                            },
                                        )),
                                    )
                                    ...
                                    .menu_element_with_icon(IconName::Info, Box::new(Info(0)), |_, cx| {
                                        h_flex().gap_1().child(t!("menu.item.custom").to_string()).child(
                                            div()
                                                .text_sm()
                                                .text_color(cx.theme().muted_foreground)
                                    ...
                                    .separator()
                                    .menu_with_disabled(t!("menu.item.disabled").to_string(), Box::new(Info(0)), true)
                                    .separator()
                                    .submenu(t!("menu.submenu.links").to_string(), window, cx, |menu, _, _| {
                                        menu.link_with_icon(
                                    ...
                                    .separator()
                                    .submenu(t!("menu.submenu.other_links").to_string(), window, cx, |menu, _, _| {
                                        menu.link(t!("menu.link.crates").to_string(), "https://crates.io")
                                            .link(t!("menu.link.rust_docs").to_string(), "https://docs.rs")
                                    })
                            }),
                    )
                                ...
                                move |this, window, cx| {
                                    this.external_link_icon(false)
                                        ...
                                        .submenu(
                                            ...
                                            cx,
                                            move |menu, _, _| {
                                                menu.menu(t!("menu.context.info_0").to_string(), Box::new(Info(0)))
                                                    .separator()
                                                    .menu(t!("menu.context.item_1").to_string(), Box::new(Info(1)))
                                                    .menu(t!("menu.context.item_2").to_string(), Box::new(Info(2)))
                                            },
                                        )
                                        .separator()
                                        .menu(t!("menu.context.search_all").to_string(), Box::new(SearchAll))
                                        .separator()
                                }
                            })
                            .child(
                        ...
                        Button::new("dropdown-menu-scrollable-1")
                            ...
                            .dropdown_menu_with_anchor(Anchor::TopRight, move |this, _, _| {
                                let mut this = this
                                    .scrollable(true)
                                    .max_h(px(300.))
                                    .label(t!("menu.scrollable.total_items", count = 100).to_string());
                                for i in 0..100 {
                                    this = this.menu(
                                        SharedString::from(t!("menu.scrollable.item", index = i).to_string()),
                                        Box::new(Info(i)),
                                    )
                                }
                                this.min_w(px(100.))
