...
pub enum AgentConfigEvent {
    ...
    AgentAdded { name: String, config: AgentProcessConfig },
    /// An existing agent's configuration was updated
    AgentUpdated { name: String, config: AgentProcessConfig },
    ...
    McpServerAdded { name: String, config: McpServerConfig },
    /// An existing MCP server's configuration was updated
    McpServerUpdated { name: String, config: McpServerConfig },
...
pub enum WorkspaceUpdateEvent {
    ...
    TaskCreated { workspace_id: String, task_id: String },
    /// A task was updated
    TaskUpdated { task_id: String },
    /// A task was removed
    TaskRemoved { workspace_id: String, task_id: String },
